...
const BlockSkeleton = () => {
  return (
    <motion.div
      className="group flex flex-col gap-4  rounded-xl  bg-card/30 backdrop-blur-sm"
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1 space-y-2">
          <motion.div
            className="h-4 bg-gradient-to-r from-muted via-muted/80 to-muted rounded-md py-5"
...
const EditorSkeleton = () => {
  return (
    <div className="w-4xl mt-5 mx-auto">
